-- Apagar Banco de Dados db_games
...
-- JOIN DE INTERSECÇÃO DA TABELA DE PRODUTO E USUÁRIO
SELECT * FROM tb_produtos INNER JOIN tb_categorias 
ON tb_produtos.categoria_id = tb_categorias.id;

-- JOIN DE USUÁRIOS E PRODUTOS
SELECT * FROM tb_produtos INNER JOIN tb_usuarios 
ON tb_produtos.usuario_id = tb_usuarios.id;
-- obs: lembrar que a tabela sempre a esquerda contem a chave estrangeira

-- INTERSECÇÃO DOS DOIS JOIN:
SELECT * FROM tb_produtos 
